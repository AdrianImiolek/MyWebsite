	...
	const cardsContent = [
		{
			...
			text: `KawusiaWebsite is a promotional website for a café called "Kawiarnia Kawusia". It presents the café's offer, atmosphere, and key information to potential customers in a clean and visually appealing way.`,
			skill: [
